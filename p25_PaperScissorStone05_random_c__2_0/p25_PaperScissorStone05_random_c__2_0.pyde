# p25_PaperScissorStone05_random_c  2.0
import random
select, computer  = -1, -1
def setup():
    size(600,300)
...
if select == computer:print('Tie')
elif select == 0 and computer == 2:print('Win')
elif select == 1 and computer == 0:print('Win')
elif select == 2 and computer == 1:print('Win')
else:print('Lose')
